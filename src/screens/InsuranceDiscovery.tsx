  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-blueBlack dark:text-beige">Insurance Discovery</h1>
      </div>
      ...
      <div className="bg-lightBeige dark:bg-forestDark rounded-lg p-4 flex items-center">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">DOB: 05/15/1980 | ID: P12345 | Added: Today</p>
        </div>
        ...
        <CardContent>
          ...
          <Tabs defaultValue="discovered">
            ...
            <TabsContent value="discovered">
              <p className="mb-4">Select the insurance coverage to verify:</p>
                ...
                <div 
                  className={`border rounded-lg p-4 cursor-pointer transition-colors ${
                    selectedInsurance === 'delta' 
                      ? 'bg-lightBeige border-forestGreen' 
                      : 'hover:bg-background'
                  }`}
              ...
              <div className="bg-lightBeige dark:bg-forestDark p-6 rounded-lg mb-6">
            ...
            <TabsContent value="history">
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-forestLight pb-4">
                  <div className="flex items-center">
                    <div className="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center mr-3">
                      <Search className="h-5 w-5 text-blue-600" />
                    </div>
                    <div>
                      <p className="font-medium">Insurance Discovery Initiated</p>
                      <p className="text-sm text-muted-foreground">Basic patient information used to search for coverage</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium">Today, 10:32 AM</p>
                    <Badge className="bg-green-100 text-green-800 border-green-200">
                ...
                <div className="flex items-center justify-between border-b border-forestLight pb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium">3 Potential Coverages Found</p>
                      <p className="text-sm text-muted-foreground">Delta Dental, Cigna, and Aetna coverage identified</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium">Today, 10:32 AM</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Verification of selected coverage pending</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-medium">Today, 10:33 AM</p>
                    <Badge className="bg-amber-100 text-amber-800 border-amber-200">
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex items-center">
            ...
            <div>
              <h4 className="font-medium">Time Saved: 25 minutes</h4>
              <p className="text-sm text-muted-foreground">Insurance discovery completed in 5 seconds vs. traditional 25-minute process</p>
            </div>
          </div>
        </CardContent>
      </Card>
