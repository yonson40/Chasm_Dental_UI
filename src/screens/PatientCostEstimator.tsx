  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-blueBlack dark:text-beige">Patient Cost Estimator</h1>
      </div>
        ...
        <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-lightBeige dark:bg-forestDark p-4 rounded-lg text-center">
              ...
              <div className="text-2xl font-bold">$1,340.00</div>
            </div>
            
            <div className="bg-lightBeige dark:bg-forestDark p-4 rounded-lg text-center">
              <div className="text-sm text-muted-foreground mb-1">Insurance Pays</div>
          ...
          {/* Visual Breakdown */}
          <div className="mb-8">
            <h3 className="text-sm font-medium text-muted-foreground mb-2">Payment Breakdown</h3>
          ...
          <Tabs defaultValue="procedures">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="text-left py-3 px-4 font-medium text-muted-foreground">Tooth</th>
                      <th className="text-right py-3 px-4 font-medium text-muted-foreground">Fee</th>
                      <th className="text-right py-3 px-4 font-medium text-muted-foreground">Coverage</th>
                      <th className="text-right py-3 px-4 font-medium text-muted-foreground">Insurance Pays</th>
                      <th className="text-right py-3 px-4 font-medium text-muted-foreground">Patient Pays</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-border">
                      <td className="py-3 px-4">
                        ...
                        <div className="text-xs text-muted-foreground">Major Restorative</div>
                      </td>
                    ...
                    <tr className="border-b border-border">
                      <td className="py-3 px-4">
                        <div className="font-medium">D0120 - Periodic Oral Evaluation</div>
                        <div className="text-xs text-muted-foreground">Diagnostic</div>
                      </td>
                      <td className="py-3 px-4">-</td>
                      <td className="py-3 px-4 text-right">$65.00</td>
            ...
            <TabsContent value="benefits">
              <div className="space-y-6">
                <div className="bg-lightBeige dark:bg-forestDark p-4 rounded-lg">
                  <h3 className="font-medium mb-4">Insurance Benefits Summary</h3>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="flex justify-between mt-1">
                        <span className="text-xs text-muted-foreground">$150 Used</span>
                        <span className="text-xs text-muted-foreground">$1,850 Remaining</span>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex justify-between mt-1">
                        <span className="text-xs text-muted-foreground">$50 Applied</span>
                ...
                <div className="space-y-4">
                  <div className="border rounded-lg p-4">
                    <h3 className="font-medium mb-3">Coverage by Service Category</h3>
                  ...
                  <div className="border rounded-lg p-4">
                    <h3 className="font-medium mb-3">Waiting Periods & Limitations</h3>
              ...
              <div className="space-y-6">
                <div className="bg-lightBeige dark:bg-forestDark p-4 rounded-lg">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="font-medium">Payment Options for $600.00</h3>
                  </div>
                ...
                <div className="border rounded-lg p-4">
                  <div className="flex items-center mb-4">
                    ...
                    <h3 className="font-medium">Financing Calculator</h3>
                  </div>
                  
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    <div>
                      <label className="text-sm text-muted-foreground block mb-1">Amount to Finance</label>
                    ...
                    <div>
                      <label className="text-sm text-muted-foreground block mb-1">Number of Months</label>
                  ...
                  <div className="bg-lightBeige dark:bg-forestDark p-4 rounded-lg mb-4">
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex items-center">
            ...
            <div>
              <h4 className="font-medium">Time Saved: 20 minutes</h4>
              <p className="text-sm text-muted-foreground">Cost estimation completed in 2 seconds vs. traditional 20-minute manual calculation process</p>
            </div>
          </div>
        </CardContent>
      </Card>
